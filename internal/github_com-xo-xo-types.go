// Code generated by 'yaegi extract github.com/KousukeUchiyama/xo/types'. DO NOT EDIT.
...
import (
	...
	"github.com/KousukeUchiyama/xo/types"
)

func init() {
	Symbols["github.com/KousukeUchiyama/xo/types/types"] = map[string]reflect.Value{
